...
int	main(void)
{
	...
	{
		numToWords(test_cases[i][0], buffer);
		if (strcmp(test_cases[i][1], buffer) != 0)
		{
			printf("%s : \n", test_cases[i][0]);
			printf("\t");
			printf("\033[1;30m"
	...
	printf("\t%s\033[0m NumToWords\n",
		pass == 1 ? "\033[1;90;102m PASS " : "\[1;97;101m FAIL ");
}
